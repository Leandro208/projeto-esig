...
public class PessoaSalarioConsolidadoService {
	...
	public void calcular() {
		String sql = "TRUNCATE TABLE pessoa_salario_consolidado";
		...
		sql += "JOIN cargo_vencimentos cv ON c.id_cargo = cv.id_cargo";
		sql += "JOIN vencimentos v ON cv.id_vencimento = v.id_vencimento";
